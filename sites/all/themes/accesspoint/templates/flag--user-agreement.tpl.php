...
<span class="<?php print $flag_wrapper_classes; ?>">
  <?php if ($link_href): ?>
    <a href="<?php print $link_href; ?>" title="<?php print $link_title; ?>" class="btn btn-success <?php print $flag_classes ?>" rel="nofollow"><?php print $link_text; ?></a><span class="flag-throbber">&nbsp;</span>
  <?php else: ?>
    <span disabled="disabled" class="btn btn-default <?php print $flag_classes ?>"><?php print $link_text; ?></span>
  <?php endif; ?>
